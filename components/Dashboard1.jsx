                ...
                <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                  ...
                  <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                    ...
                    <Menu as="div" className="relative ml-5 flex-shrink-0">
                      <div>
                        <Menu.Button className="relative flex rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2">
              ...
              <Popover.Panel as="nav" className="lg:hidden" aria-label="Global">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="mx-auto flex max-w-3xl items-center px-4 sm:px-6">
                    ...
                    <button
                      type="button"
                      className="relative ml-auto flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2"
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">View notifications</span>
                      <BiBell
                ...
                <div className="mx-auto mt-6 max-w-3xl px-4 sm:px-6">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-sky-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-rose-700"
                  >
                    New Post
                  </a>
                          ...
                          <div className="mt-4 border border-gray-300 rounded divide-y divide-gray-300">
                            <div className="p-4">
                              <div className="flex flex-row text-slate-700 space-x-2">
                                ...
                                <IoIosArrowDown className="mt-1 text-lg font-extrabold" />
                                <span className="w-1 h-1 mt-3 text-md bg-gray-300 text-gray-300" />
